...
const Button = ({ buttonText, buttonLink }) => {
  return (
    <Link
      to={buttonLink}
      className="flex items-center justify-center gap-[10px] px-6 py-[18px] bg-[#23298B] hover:bg-[#23288bc9] transition-colors duration-500 rounded-[8px]"
    >
      <p className="text-[14px] text-white font-medium leading-[140%]">
        {buttonText}
      </p>
      <svg
