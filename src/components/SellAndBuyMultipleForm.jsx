...
const SellAndBuyMultipleForm = () => {
  ...
  const steps = [
    ...
    //         <button
    //           className={`pb-2 px-4 ${currentStep === 0 ? 'border-b-2 border-blue-600' : ''}`}
    //         >
    //           Sell
    //         </button>
    //         <button className="pb-2 px-4">Buy</button>
    //         <button className="pb-2 px-4">Sell & Buy</button>
    //       </div>
    //       <Input
    //         placeholder="Enter the address you are selling"
    //         value={formData.addressToSell}
    //         onChange={(e) => updateFormData('addressToSell', e.target.value)}
    //       />
    //       <Button className="w-32 ml-auto" onClick={handleNext}>
    //         Compare Agents
    //       </Button>
    //     </div>
    //   )
      ...
      content: (
        <div className="space-y-4">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold">Where are you looking to Sell and Buy?</h2>
...
export default SellAndBuyMultipleForm;