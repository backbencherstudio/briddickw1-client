    ...
    // Step 7: Contact Details
    {
      content: (
        <div className="w-[815px] h-[738px] mx-auto flex flex-col">
          ...
          This is where RealEstateAgents.com and our agents will contact you to discuss your needs
          </p>
          ...
          <p className="text-lg font-normal text-gray-500 mt-4">
            ...
            RealEstateAgents <span className="text-[#23298B]">Terms of Use</span> and <span className="text-[#23298B]">Privacy Policy</span>, which includes
